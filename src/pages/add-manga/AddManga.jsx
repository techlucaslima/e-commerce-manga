                    ...
                    <div id="form-container">
                        <form id="create-manga-form" onSubmit={handleSubmit}>
                            ...
                            <div>
                                ...
                                <input type="text" id="imagem" name="imagem" value={formData.imagem} onChange={handleChange}/><br />
                            </div>
                            <div>
                                <label htmlFor="sinopse">Sinopse</label><br />
                                <input type="text" id="sinopse" name="sinopse" value={formData.sinopse} onChange={handleChange} />
                            </div>
                            <div>   
                                <label htmlFor="autor">Autor</label><br />
                                <input type="text" id="autor" name="autor" value={formData.autor} onChange={handleChange}/><br />
                            </div>
                            <div>
